...
CREATE OR REPLACE procedure clob_replace (source in out nocopy clob, search_string in varchar2, replacement_string in clob default  EMPTY_CLOB())  IS
    ...
    begin
        ...
        loop
            ...
            l_pos := l_pos + length(search_string);
        end loop;
